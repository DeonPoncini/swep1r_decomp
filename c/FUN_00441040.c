...

{
  ...
  if (((local_48[0] != _DAT_004aca50) || (local_48[1] != _DAT_004aca50)) ||
     (local_48[2] != _DAT_004aca50)) {
    FUN_0042f9f0(local_48,local_48 + 9,param_5);
    FUN_0042f9f0(local_48 + 3,&local_18,param_6);
    FUN_0042f9f0(local_48 + 6,&local_c,param_7);
    if (_DAT_004aca50 <= local_48[0]) {
      param_3 = (float *)local_48[0];
    }
    else {
      param_3 = (float *)-local_48[0];
    }
    if (_DAT_004aca50 <= local_48[1]) {
      param_2 = (float *)local_48[1];
    }
    else {
      param_2 = (float *)-local_48[1];
    }
    if (local_48[2] < _DAT_004aca50) {
      local_48[2] = -local_48[2];
    }
    if (local_48[2] + (float)param_2 + (float)param_3 <= _DAT_004aca54) {
      if (_DAT_004aca50 <= local_48[3]) {
        param_3 = (float *)local_48[3];
      }
      else {
        param_3 = (float *)-local_48[3];
      }
      if (_DAT_004aca50 <= local_48[4]) {
        param_2 = (float *)local_48[4];
      }
      else {
        param_2 = (float *)-local_48[4];
      }
      if (local_48[5] < _DAT_004aca50) {
        local_48[5] = -local_48[5];
      }
      if (local_48[5] + (float)param_2 + (float)param_3 < _DAT_004aca60) {
        return 1;
      }
      ...
      if ((float)_DAT_004aca58 <= local_48[iVar1 + 3]) {
        if (_DAT_004aca50 <= local_48[iVar1 + 6]) {
          return 1;
        }
      }
      else if (local_48[iVar1 + 6] <= _DAT_004aca50) {
        return 1;
      }
    }
    else {
      ...
      if ((float)_DAT_004aca58 <= local_48[iVar1]) {
        if ((_DAT_004aca50 <= local_48[iVar1 + 3]) && (_DAT_004aca50 <= local_48[iVar1 + 6])) {
          return 1;
        }
      }
      else if ((local_48[iVar1 + 3] <= _DAT_004aca50) && (local_48[iVar1 + 6] <= _DAT_004aca50)) {
        return 1;
      }
    }
  }
